...
UPDATE products SET description = 'Crisp, fresh lettuce with tightly layered leaves that hold their crunch well past washing. Use as a wrap base, in layered salads, or as a bed for grilled proteins. Wash in cold water before use. Keeps 4–5 days refrigerated.' WHERE name = 'Lettuce';

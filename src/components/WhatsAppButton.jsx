...
export default function WhatsAppButton({ message }) {
  const url = `https://wa.me/${WHATSAPP_NUMBER.replace(/\D/g, '')}?text=${encodeURIComponent(
    message || 'Hi! I need help with my order at KR Vegetables & Fruits.'
  )}`
  ...
  return (
    ...
    >
      ...
      <span style={{ color: '#fff', fontFamily: 'var(--font-body)', fontSize: '13px', fontWeight: 600, letterSpacing: '.01em' }}>
        Chat
      </span>
    </a>
  )

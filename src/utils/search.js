...
const DICT = {
  ...
  'seethappazham':    ['custard apple'],

  // ── Additional Tanglish / local terms ────────────────────────────────────
  'palapazham':       ['jackfruit'],
  'palaapaazham':     ['jackfruit'],
  'pala':             ['jackfruit'],
  'mulampaazham':     ['muskmelon', 'melon'],
  'mulaampazham':     ['muskmelon'],
  'thamarathandu':    ['lotus stem'],
  'thamara thandu':   ['lotus stem'],
  'araikeerai':       ['amaranth'],
  'arai keerai':      ['amaranth'],
  'manjal kizhangu':  ['turmeric root', 'turmeric'],
  'manjalkizhangu':   ['turmeric root'],
  'manjal':           ['turmeric'],
  'litchi':           ['lychee', 'litchi'],
  'licci':            ['lychee'],
  'lichchi':          ['lychee'],
  'naattu thengai':   ['coconut'],
  'thengai':          ['coconut'],
  'elumichai':        ['lemon', 'lime'],
  'elumichampazham':  ['lemon', 'lime'],
  'chinna elumichai': ['lime'],
  'mosambi':          ['sweet lime', 'mosambi'],
  'murunga keerai':   ['drumstick leaves', 'moringa'],
  'murungai keerai':  ['drumstick leaves', 'moringa'],
  'venthayam':        ['fenugreek', 'methi'],
  'venthaya keerai':  ['methi', 'fenugreek'],
  'sombu ilai':       ['dill leaves'],
  'perunjeeragam':    ['dill leaves', 'fennel'],
  'mathai':           ['bitter gourd', 'pavakkai'],
  'leechi':           ['lychee'],
}
